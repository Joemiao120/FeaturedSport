...
/**
 * Implementation for [ContentRepository]
 *
 */
class DefaultContentRepository @Inject constructor() : ContentRepository {
    override suspend fun getFeaturedSports(): List<Sport> {
        delay(5000)
        return createMockedSports()
    }

    private fun createMockedSports(): List<Sport> =
        listOf(
            Sport(
                "Cycling",
